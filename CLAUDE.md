...
> **Проверка навигации архива.** После извлечения body во всех 4 файлах `src/legacy/{year}/{index,photos,reviews,team}.body.html` все ссылки `.menu__link` должны вести на `/{year}/...`, а не на корень текущего сезона. Прогон: `grep -nE 'href="/(#?(program|members|partners|map|photos|reviews|team))?" class="menu__link"' src/legacy/{year}/*.body.html` — вывод должен быть пустой. Если что-то найдено — переписать на `/{year}/`, `/{year}/#program`, `/{year}/photos` и т.д. Иначе клики из архива уведут на главный сайт текущего сезона (баг был у 2023 на `/reviews`, у 2024 и 2025 — на «О фестивале», `/photos`, `/reviews`, `/team` и всех якорях).
